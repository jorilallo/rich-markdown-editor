...
var CopyButton = function (_React$Component) {
  ...
  function CopyButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CopyButton.__proto__ || Object.getPrototypeOf(CopyButton)).call.apply(_ref, [this].concat(args))), _this), _this.state = { copied: true }, _this.handleCopy = function () {
...
})(["position:absolute;top:0;right:0;opacity:0;transition:opacity 50ms ease-in-out;z-index:1;font-size:12px;background:", ";border-radius:0 2px 0 2px;padding:1px 6px;cursor:pointer;&:hover{background:", ";}"], function (props) {
