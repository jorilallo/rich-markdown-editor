...
var Image = function (_React$Component) {
  ...
  function Image() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Image.__proto__ || Object.getPrototypeOf(Image)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (ev) {
...
var StyledImg = _styledComponents2.default.img.withConfig({
  displayName: "Image__StyledImg"
})(["max-width:100%;box-shadow:", ";border-radius:", ";opacity:", ";"], function (props) {
  return props.active ? "0 0 0 2px " + props.theme.slate : "0";
}, function (props) {
...
var Caption = _styledComponents2.default.input.withConfig({
  displayName: "Image__Caption"
})(["border:0;display:block;font-size:13px;font-style:italic;color:", ";padding:2px 0;line-height:16px;text-align:center;width:100%;outline:none;background:none;&::placeholder{color:", ";}"], function (props) {
