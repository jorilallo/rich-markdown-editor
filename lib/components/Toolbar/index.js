...
var Toolbar = function (_React$Component) {
  ...
  function Toolbar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.state.mouseDown) active = false;
...
})(["padding:8px 16px;position:absolute;z-index:2;top:-10000px;left:-10000px;opacity:0;background-color:", ";border-radius:4px;transform:scale(0.95);transition:opacity 150ms cubic-bezier(0.175,0.885,0.32,1.275),transform 150ms cubic-bezier(0.175,0.885,0.32,1.275);transition-delay:250ms;line-height:0;height:40px;min-width:300px;box-sizing:border-box;pointer-events:none;*{box-sizing:border-box;}", ";@media print{display:none;}"], function (props) {
