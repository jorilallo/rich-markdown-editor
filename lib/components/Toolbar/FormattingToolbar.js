  ...
  function FormattingToolbar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormattingToolbar.__proto__ || Object.getPrototypeOf(FormattingToolbar)).call.apply(_ref, [this].concat(args))), _this), _this.hasMark = function (type) {
      ...
      return React.createElement(
        ...
        React.createElement(IconClass, { light: true })
      );
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(_outlineIcons.LinkIcon, { light: true })
        )
      );
    }
  }]);
...
var Separator = _styledComponents2.default.div.withConfig({
  displayName: "FormattingToolbar__Separator"
})(["height:100%;width:1px;background:#fff;opacity:0.2;display:inline-block;margin-left:10px;"]);

exports.default = FormattingToolbar;