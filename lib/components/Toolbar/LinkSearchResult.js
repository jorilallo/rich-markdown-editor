...
})(["display:flex;align-items:center;height:28px;padding:6px 8px 6px 0;color:", ";font-size:15px;overflow:hidden;white-space:nowrap;i{visibility:hidden;}&:hover,&:focus,&:active{font-weight:500;outline:none;i{visibility:visible;}}"], function (props) {
