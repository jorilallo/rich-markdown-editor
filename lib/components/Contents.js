...
})(["display:none;position:fixed;right:0;top:150px;z-index:100;@media print{display:none;}"]);

var Anchor = _styledComponents2.default.a.withConfig({
  displayName: "Contents__Anchor"
})(["color:", ";font-weight:", ";opacity:0;transition:all 100ms ease-in-out;margin-right:-5px;padding:2px 0;pointer-events:none;text-overflow:ellipsis;&:hover{color:", ";}"], function (props) {
  return props.active ? props.theme.slateDark : props.theme.slate;
}, function (props) {
