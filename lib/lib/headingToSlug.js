...
function indexOfType(document, heading) {
  var slugified = (0, _escape3.default)((0, _slug2.default)(heading.text));
  var headings = document.nodes.filter(function (node) {
    if (!node.text) return false;
    return node.type.match(/^heading/) && slugified === (0, _escape3.default)((0, _slug2.default)(node.text));
  });
...
function headingToSlug(document, node) {
  var slugified = (0, _escape3.default)((0, _slug2.default)(node.text));
